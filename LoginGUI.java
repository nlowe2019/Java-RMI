...
public class LoginGUI extends GUIPage implements ActionListener {
        ...
        public void buildPage() {
                ...
                registerPanelLayout.setHorizontalGroup(registerPanelLayout
                                                                ...
                                                                .addGroup(registerPanelLayout.createSequentialGroup()
                                                                                .addGroup(registerPanelLayout
                                                                                                .createParallelGroup(
                                                                                                                ...
                                                                                                                false)
                                                                                                .addComponent(registerEmailTag,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                80,
                                                                                                                Short.MAX_VALUE)
                                                                                                .addComponent(registerNameTag,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                Short.MAX_VALUE))
                                                                                .addPreferredGap(
                                                                                ...
                                                                                .addGroup(registerPanelLayout
                                                                                                ...
                                                                                                .addComponent(registerNameInput,
                                                                                                                ...
                                                                                                                200,
                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                                .addComponent(registerEmailInput,
                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                200,
                                                                                                                GroupLayout.PREFERRED_SIZE))))
                                                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
                registerPanelLayout.setVerticalGroup(registerPanelLayout
                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(registerPanelLayout.createSequentialGroup().addContainerGap()
                                                .addGroup(registerPanelLayout
                ...
                pageLayout.setHorizontalGroup(pageLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(pageLayout.createSequentialGroup().addContainerGap().addGroup(pageLayout
                                                .createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addComponent(loginPanel, GroupLayout.DEFAULT_SIZE,
                                                                GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(registerPanel, GroupLayout.Alignment.TRAILING,
                                                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                                Short.MAX_VALUE))
                                                .addContainerGap()));
                pageLayout.setVerticalGroup(pageLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        public void login() throws RemoteException, NoSuchAlgorithmException, IOException, InvalidKeyException,
                IllegalBlockSizeException, NoSuchPaddingException, ClassNotFoundException, BadPaddingException {

                String email = loginEmailInput.getText();
                boolean successful = client.remoteLoginUser(email);
                if(!successful)
    ...
    public void register() throws RemoteException, NoSuchAlgorithmException, IOException {
        ...
        boolean successful = client.remoteRegisterUser(email, name);
        if(!successful)
            ...
            if (e.getSource() == registerButton) {
                if (registerEmailInput.getText().equals("") || registerNameInput.getText().equals("")) {
                    ...
                    register();
                        ...
                        | NoSuchPaddingException | ClassNotFoundException | BadPaddingException exception) {
